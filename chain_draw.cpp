...
void DrawOneDim(TH1F *xDistr, TH1F *yDistr, const char* name, TFile* myFile)
{
...
void DrawTwoDim(TH2F *hist2D, const char* name, string type, TFile* myFile)
{
    Double_t w = 700;
    Double_t h = 700;
...
void DrawThreeDim(TH3F *hist3D, const char* name, string type, TFile* myFile)
{
    Double_t w = 700;
    Double_t h = 700;
...
int main()
{
    ...
    {   
        ...
        TH2F *x_y = new TH2F("x_y", "X-Y distribution; X (mm); Y (mm); Entries", 60, -120, 120, 60, -120, 120);
